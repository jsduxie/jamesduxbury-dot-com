...
const ContactModal: React.FC<ContactModalProps> = ({ setOpen }) => {
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="align-center max-w-md flex-col rounded-xl bg-white p-6 shadow-lg dark:bg-gray-900">
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <Button
            type="submit"
            className="w-full focus:shadow-[0_0_15px_#3182ce]"
            disabled={loading}
          >

...
const ProjectCard: React.FC<Project> = ({ imagePath, title, techStack, description, githubLink, liveLink }) => {
    return (
      <div className="w-full flex flex-col lg:flex-row items-center justify-center bg-white dark:bg-gray-800 rounded-lg shadow-lg p-10 gap-8">
        ...
        <div className="absolute w-[200px] h-[200px] bg-[#3182ce] rounded-full blur-[100px] opacity-50 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-0"></div>
        ...
        >
            ...
            width={250} 
            height={250} 
            className="border-2 border-accent shadow-[0_0_20px_#3182ce] rounded-lg object-cover"
            />
        </div>
        </div>
...
export const Projects = () => {
    ...
    return (
        <section className="w-full bg-background py-12 text-white shadow-[0_0_15px_#3182ce] relative" id="projects">
            ...
            <div className="container mx-auto px-4">
                ...
                <div className="space-y-8">
                    {projects.map((project, index) => (
                        ...
                        description={project.description} githubLink={project.githubLink} liveLink={project.liveLink}/>
                    ))}
                </div>
            </div>
        </section>

import type { Feature } from '@/data/about';

// single-path 24x24 glyphs in the simple-icons style (currentColor fill), one per toolbar action
const ICON_PATHS: Record<Feature, string> = {
  ...
  code: 'M8.6 7.4 4 12l4.6 4.6L10 15.2 6.8 12 10 8.8zm6.8 0L20 12l-4.6 4.6L14 15.2 17.2 12 14 8.8z',
  ...
  heading: 'M5 4v3h5.5v12h3V7H19V4z',
  image:
    'M21 19V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2zM8.5 13.5l2.5 3.01L14.5 12l4.5 6H5l3.5-4.5z',
};

export function BlockIcon({ name }: { name: Feature }) {
  return (
